...
cdef extern from "sunlinsol/sundials_pcg.h":
    struct _SUNLinearSolverContent_PCG:
        int maxl
        int pretype
        int numiters
    ...
    SUNLinearSolver_ID SUNLinSolGetID_PCG(SUNLinearSolver S)
    int SUNLinSolInitialize_PCG(SUNLinearSolver S)
    int SUNLinSolSetATimes_PCG(SUNLinearSolver S, void* A_data,
                               ATimesFn ATimes)
    int SUNLinSolSetPreconditioner_PCG(SUNLinearSolver S, void* P_data,
                                       PSetupFn Pset, PSolveFn Psol)
    int SUNLinSolSetScalingVectors_PCG(SUNLinearSolver S, N_Vector s,
...
cdef extern from "sunlinsol/sundials_spgmr.h":
    struct _SUNLinearSolverContent_SPGMR:
        int maxl
        int pretype
        int gstype
...
cdef extern from "sunlinsol/sundials_spbcgs.h":
    struct _SUNLinearSolverContent_SPBCGS:
        int maxl
        int pretype
        int numiters
    ...
    int SUNLinSolSetATimes_SPBCGS(SUNLinearSolver S, void* A_data,
                                  ATimesFn ATimes)
    int SUNLinSolSetPreconditioner_SPBCGS(SUNLinearSolver S, void* P_data,
                                          PSetupFn Pset, PSolveFn Psol)
    ...
    N_Vector SUNLinSolResid_SPBCGS(SUNLinearSolver S)
    sunindextype SUNLinSolLastFlag_SPBCGS(SUNLinearSolver S)
    int SUNLinSolSpace_SPBCGS(SUNLinearSolver S, long int *lenrwLS,
                              long int *leniwLS)
    int SUNLinSolFree_SPBCGS(SUNLinearSolver S)

cdef extern from "sunlinsol/sundials_spfgmr.h":
    struct _SUNLinearSolverContent_SPFGMR:
        int maxl
        int pretype
        int gstype
...
cdef extern from "sundials/sundials_sptfqmr.h":
    ...
    int SUNLinSolSetATimes_SPTFQMR(SUNLinearSolver S, void* A_data,
                                   ATimesFn ATimes)
    int SUNLinSolSetPreconditioner_SPTFQMR(SUNLinearSolver S,
                                           void* P_data, PSetupFn Pset,
                                           PSolveFn Psol)
