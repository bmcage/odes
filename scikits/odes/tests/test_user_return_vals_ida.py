...
def normal_jac(t, y, ydot, cj, residual, J):
    J[0][0] = cj

def jac_with_return(t, y, ydot, cj, residual, J):
    J[0][0] = cj
    return 0

def jac_problem_late(t, y, ydot, cj, residual, J):
    J[0][0] = cj + 1
    if t > 0:
        return 1

def jac_problem_immediate(t, y, ydot, cj, residual, J):
    return 1

def jac_error_late(t, y, ydot, cj, residual, J):
    J[0][0] = cj + 1
    if t > 0:
        return -1

def jac_error_immediate(t, y, ydot, cj, residual, J):
    return -1
